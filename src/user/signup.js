      ...
      <div className="formContent">
        <form>
          ...
          <div className="bottom-button">
            ...
            <div id="formFooter">
              <Link to="/signin" className="alreadyhaveaccount">
      ...
      <>
        ...
        <div className="position">
          <div className="formContent formContent1 ">
            <div
              className="alert alert-danger big-font-1"
            ...
            <div
              className="alert alert-info big-font-1"
              style={{ display: open ? "" : "none" }}
            >
              New account has successfully created.please{" "}

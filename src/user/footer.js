                ...
                <div className="right_footer">
                    <div className="contact_footer">
                        ...
                        <div clasName="contact_info">
                            <p>  <i className='fas fa-phone ficon'></i> &nbsp; 9999999999<br /><br />
                                <i className='fas fa-envelope ficon'></i> &nbsp; cryptotracker@gmail.com<br /><br />
                                <i className='fa fa-home ficon'></i> &nbsp; 10-my building, Bombay 11111,India<br /><br />
                            </p>
                        </div>
                    </div>

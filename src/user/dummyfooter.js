                ...
                <div className="dright_footer">
                    <div className="dcontact_footer">
                        ...
                        <div clasName="dcontact_info">
                            <p>  <i clasName='fas fa-phone dficon'></i> &nbsp; 9999999999<br /><br />
                                <i clasName='fas fa-envelope dficon'></i> &nbsp; cryptotracker@gmail.com<br /><br />
                                <i clasName='fa fa-home dficon'></i> &nbsp; 10-my building, Bombay 11111,India<br /><br />
                            </p>
                        </div>
                    </div>
